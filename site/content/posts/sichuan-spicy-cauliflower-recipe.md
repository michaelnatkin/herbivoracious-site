---
title: "Sichuan Spicy Cauliflower - Recipe"
date: 2013-03-18T06:40:27
slug: "sichuan-spicy-cauliflower-recipe"
...
<div class="recipe-card">
  <h2 class="recipe-card-title">Sichuan Spicy Cauliflower</h2>
  <div class="recipe-card-meta">
    <span>Prep: 10 min</span> | <span>Cook: 40 min</span>
  </div>
  <h3>Ingredients</h3>
  <ul>
  ...
  <h3>Instructions</h3>
  <h4>To cook sous vide:</h4>
<ol>
  <li>Divide all ingredients among two sous vide bags. Seal under maximum vacuum if available. Cook at 85 C / 185 F until tender, about 40 mins. Allow to cool slightly, then remove from bag, and, if desired broil or blowtorch to brown in spots. Taste and adjust seasoning and serve.</li>
</ol>
<h4>To stir fry (untested!)</h4>
<ol>
  <li>Microwave florets at high power until partly tender. Drain off any water. Heat a large skillet over high heat. Add the oil, salt, Sichuan peppercorn, garlic, and ginger. Stir-fry for just a few seconds, then add the cauliflower, and stir-fry until cooked through and browned in spots, about 5 minutes. Taste and adjust seasoning and serve.</li>
</ol>
</div>
