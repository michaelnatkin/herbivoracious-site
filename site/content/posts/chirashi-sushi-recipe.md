...
recipe:
  ...
  instructions:
    - "For the sushi rice: Cook the rice using a rice cooker or according to package directions. Whisk together the rice vinegar, sugar, and 4 teaspoons of salt."
    ...
    - "For the cooked toppings: Cut the eggplant in half lengthwise, and if using medium eggplants, again in half crosswise. Score the skin side of each eggplant in a fine diamond pattern, about ¼” apart."
    - "Heat a large skillet over a medium-high flame and add 1 tablespoon of oil. Cook the eggplants with the flesh side down until starting to brown. Flip and cook with the skin side down for two minutes. Add 1/3 cup of water; cover the pan, and continue cooking until thoroughly tender, about 3-5 more minutes. Remove the eggplant and season with salt."
    - "In the same pan, add 1 more tablespoon of oil, raise the heat to high, and stir-fry the beech mushrooms for 1 minute, and then remove. Repeat with the shiitake mushrooms caps."
    - "Return the heat to high, add the remaining tablespoon of oil to the pan, and fry the tofu in a single layer until golden brown, about 2 minutes on each side. Remove and season with salt."
