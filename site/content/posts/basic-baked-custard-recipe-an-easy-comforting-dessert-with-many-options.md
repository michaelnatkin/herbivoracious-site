---
title: "Basic Baked Custard Recipe - An Easy, Comforting Dessert with Many Options"
date: 2012-07-30T06:00:11
slug: "basic-baked-custard-recipe-an-easy-comforting-dessert-with-many-options"
...
<ol>
	<li>Thoroughly strain the base before baking. <strong>Here's a great trick</strong> I learned from Dave (<a href="https://twitter.com/cookingissues" target="_blank">@cookingissues</a>) Arnold: if you are going to strain something first through a coarse and then fine strainer, just nest them rather than pouring back and forth. Smacked my head when I heard that.</li>
	<li>Use a hot water bath surrounding the ramekins to moderate the temperature.</li>
	<li>Don't overbake them.</li>
</ol>
...
<div>
<ol>
	<li>Preheat the oven to 350. Bring a kettle of water to a boil Set the ramekins in a baking dish.</li>
